        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href={require("../../assets/slides/02_Graph_Learning_Basics.pdf")}>
                slides
              </a>
              ]
            </td>
          ...
          <tr>
            ...
            <td>Paper reading & analysis</td>
            <td>
              <a href="https://canvas.illinois.edu/courses/63144/assignments/1415873" target="_blank" rel="noopener noreferrer">
                Writing task 1
              </a>
               , out</td>
            <td></td>
          ...
          <tr>
            <td>Sept 26 Fri</td>
            <td>Graph neural networks: alternatives and add-ons[
          ...
          <tr>
            <td>Oct 03 Fri</td>
            <td>GNN: PyG & GraphGym[
                <a href={require("../../assets/slides/12_GNN_Implementation.pdf")}>
                slides
              </a>
              ]</td>
            <td>Ideate & discussion</td>
